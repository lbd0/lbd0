...
* **유니티**
  ...
  2. 🎮[심박수 활용 반응형 VR 콘텐츠](https://github.com/lbd0/HeartRate_WatchApp)
  ...
  3. 🎮[노인을 위한 가상현실 요리체험 VR 콘텐츠](https://github.com/lbd0/UnityProject_ExitZombie)
    + 개요 : 
    + 제작 인원 : 3명
    + 맡은 역할 : 
  4. 🎮[요리 교육 VR 콘텐츠](https://github.com/lbd0/UnityProject_ExitZombie)
    + 개요 : 
    + 제작 인원 : 3명
    + 맡은 역할 :              
***
...
3. 2023한국컴퓨터그래픽스학회 논문 투고 (심박수를 활용한 맞춤형 VR 반응형 콘텐츠)
4. 노인을 위한 가상현실 요리체험 콘텐츠 제작
5. 2024HCI 학술대회 포스터 논문 투고 (노인을 위한 가상현실 요리체험 인지능력 향상 프로그램)
6. 🏅2023 1학기 SW 캡스톤 디자인 경진대회 장려상 수상
7. 🏅2023한국컴퓨터그래픽스학회 우수학부포스터상 수상
8. SW 학술 동아리 '씨애랑' 운영진 기획국장 - 동아리 행사 기획 및 진행
9. GVE(Graphics & Virtual Environment) Lab 학부연구생
***
## 📚2024 수강 과목 (전공&복수전공)
|번호|과목명|
|:---:|:---:|
